...
(ert-deftest test-base-url ()
  (let ((testcases '(("https://github.com/user/repo" . ("foo.txt" "https://github.com/user/repo.git"))
                     ...
                     ("https://git.sr.ht/~user/repo" . ("foo.txt" "https://git.sr.ht/~user/repo.git"))
                     ("https://git.sr.ht/~user/repo" . ("foo.txt" "git@git.sr.ht:~user/repo"))
                     ("https://gitlab.com/user/repo" . ("foo.txt" "https://gitlab.com/user/repo.git"))
                     ("https://gitlab.com/user/repo" . ("foo.txt" "git@gitlab.com:user/repo.git")))))
    (dolist (testcase testcases)
      (let ((expected (car testcase))
            (input (cdr testcase)))
